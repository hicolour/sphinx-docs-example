...
epub_identifier = "http://"
epub_scheme = "URL"
epub_cover = ("../_sphinx/static/logo.png", "")
...
latex_documents = [
  ('test', 'Product.tex', u' Product Documentation',
   u'Company', 'manual'),
